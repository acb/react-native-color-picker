...
var TriangleColorPicker = /** @class */ (function (_super) {
  ...
  function TriangleColorPicker(props, ctx) {
    ...
    _this._pickerResponder = createPanResponder({
      onStart: function (_a) {
        var x = _a.x,
          y = _a.y;
        var _b = _this._computeColorFromTriangle({ x: x, y: y }),
          s = _b.s,
          v = _b.v;
  ...
  TriangleColorPicker.prototype._onLayout = function (l) {
    ...
    InteractionManager.runAfterInteractions(function () {
      ...
      this.pickerContainerRef &&
        this.pickerContainerRef.measure(function (
          x,
          y,
          width,
          height,
  ...
  TriangleColorPicker.prototype._handleSVColorChange = function (_a) {
    var x = _a.x,
      y = _a.y;
    var _b = this._computeColorFromTriangle({ x: x, y: y }),
      h = _b.h,
      rawS = _b.s,
      rawV = _b.v;
  ...
  TriangleColorPicker.prototype._normalizeTriangleTouch = function (
    s,
    v,
    sRatio
  ) {
